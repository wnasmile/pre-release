...
// Convenience alias — all files reference showToast() directly (no window. prefix needed
// because this file runs before them and the function is in the shared scope).
