...
// Defined here once; commands.js references window.THEME_MAP instead of duplicating it.
window.THEME_MAP = {
  "0": "root",       "1": "redux",     "2": "classic",  "3": "light",
  "4": "dark",       "5": "slackerish","6": "graduation","7": "flower-boy",
  "8": "igor",       "9": "i-am-music",
  "R": "root",
  // name aliases used by set:theme() in commands.js
  root: "root",           redux: "redux",       classic: "classic",
  light: "light",         dark: "dark",         slackerish: "slackerish",
  graduation: "graduation","flower-boy": "flower-boy", igor: "igor",
...
function _applyTheme(keyOrName) {
  const theme = window.THEME_MAP[keyOrName] || keyOrName;
...
document.addEventListener("keydown", (e) => {
  ...
  // 0–9 — debug theme hotkeys (shared map with commands.js)
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // ── Profile pic (secondary — primary is profile.js; only fills in if pfp has no saved src) ──
  if (pfp && !pfp.src && !localStorage.getItem("profilePic")) {
    // profile.js handles this; this block is a no-op safety net only
  } else if (pfp) {
